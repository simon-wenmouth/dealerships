...
directory_name=os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..',  '..', 'data', 'cadillac'))
...
url='http://www.cadillac.com/bypass/gmna/dealerlocator/services/getdealers?type=PostalCode&format=JSON&x-country=US&x-language=en&x-brand=Cadillac&postalcode={0}'
...
combined_name=os.path.join(os.path.dirname(directory_name), 'cadillac.json')
