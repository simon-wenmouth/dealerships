...
directory_name=os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..',  '..', 'data', 'buick'))
...
url='http://www.buick.com/bypass/gmna/dealerlocator/services/getdealers?type=PostalCode&format=JSON&x-country=US&x-language=en&x-brand=Buick&postalcode={0}'
...
combined_name=os.path.join(os.path.dirname(directory_name), 'buick.json')
