...
directory_name=os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..',  '..', 'data', 'mini'))
...
url='http://www.miniusa.com/api/dealer/dealerLookup.action?zip={0}'
...
combined_name=os.path.join(os.path.dirname(directory_name), 'mini.json')
...
for file_name in file_names:
    with open(file_name, 'r') as fd:
        ...
        for dealer in results:
            dealer_id=dealer['dealer_center_id']
