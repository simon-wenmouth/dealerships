...
directory_name=os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..',  '..', 'data', 'volkswagen'))
...
url='http://www.vw.com/vwsdl/rest/product/dealers/zip/{0}.json'
...
combined_name=os.path.join(os.path.dirname(directory_name), 'volkswagen.json')
